...
export const RandomizeIcon: React.FC<IconProps> = (props) => (
  <span onClick={() => props.onClick && props.onClick()}>
    <svg fill="#06E7EC" className={props.styling || styles.smallIcon} viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
